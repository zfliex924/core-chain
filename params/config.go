...
var (
	...
	DEVChainConfig = &ChainConfig{
		...
		BerlinBlock:         big.NewInt(145555),
		LondonBlock:         big.NewInt(145555),
		HertzBlock:          big.NewInt(145555),
		ShanghaiTime:        newUint64(1726639200),
		KeplerTime:          newUint64(1726639200),
		DemeterTime:         newUint64(1726639200),
		Satoshi: &SatoshiConfig{
			Period: 3,
			Epoch:  20,
			Round:  1800,
