...
var (
	...
	DEVChainConfig = &ChainConfig{
		...
		BerlinBlock:         big.NewInt(109888),
		LondonBlock:         big.NewInt(109888),
		HertzBlock:          big.NewInt(109888),
		ShanghaiTime:        newUint64(1725865200),
		KeplerTime:          newUint64(1725865200),
		DemeterTime:         newUint64(1725865200),
		Satoshi: &SatoshiConfig{
			Period: 3,
			Epoch:  20,
			Round:  1800,
